...
//    
    ...
    private JTextField cost1, cost2;

    public JTextField getCost1() {
        return cost1;
    }

    public void setCost1(JTextField cost1) {
        this.cost1 = cost1;
    }

    public JTextField getCost2() {
        return cost2;
    }

    public void setCost2(JTextField cost2) {
        this.cost2 = cost2;
    }
    private JLabel txtcost1, txtcost2;
...
"<br>•	Miễn phí đo huyết áp ");
        ...
        cost2 = new JTextField(8);
        txtcost1 = new JLabel("Từ:");
        txtcost1.setFont(new Font("Arial", Font.BOLD, 13));
        txtcost1.setForeground(new Color(0, 0, 139));
        
        txtcost2 = new JLabel("đến:");
        txtcost2.setFont(new Font("Arial", Font.BOLD, 13));
        txtcost2.setForeground(new Color(0, 0, 139));
        ...
        String cost[] = {"Mặc định", "8.000.000", "10.000.000", "12.000.000", "14.000.000"};
        ...
        String opKhac[] = {"Tìm theo Ngày Tiêm", "Tìm theo Tên", "Tìm theo khoảng Giá Tiền", "Tìm theo Gói Tiêm"};
...
//            layout.putConstraint(SpringLayout.NORTH, vienlbd, 0, SpringLayout.NORTH, tab3);
        ...
        layout.putConstraint(SpringLayout.WEST, cost1, 470, SpringLayout.WEST, tab3);
        layout.putConstraint(SpringLayout.NORTH, cost1, 240, SpringLayout.NORTH, tab3);
        layout.putConstraint(SpringLayout.WEST, txtcost1, 445, SpringLayout.WEST, tab3);
        layout.putConstraint(SpringLayout.NORTH, txtcost1, 245, SpringLayout.NORTH, tab3);
        
        layout.putConstraint(SpringLayout.WEST, cost2, 600, SpringLayout.WEST, tab3);
        layout.putConstraint(SpringLayout.NORTH, cost2, 240, SpringLayout.NORTH, tab3);
        layout.putConstraint(SpringLayout.WEST, txtcost2, 570, SpringLayout.WEST, tab3);
        layout.putConstraint(SpringLayout.NORTH, txtcost2, 245, SpringLayout.NORTH, tab3);
        ...
        layout.putConstraint(SpringLayout.WEST, cbTkiem, 700, SpringLayout.WEST, tab3);
        ...
        layout.putConstraint(SpringLayout.NORTH, messageL, 270, SpringLayout.NORTH, tab3);
    ...
    private void updateGiaField() {
        cost1.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                String text = cost1.getText().replaceAll("\\D", "");
                if (!text.isEmpty()) {
                    long value = Long.parseLong(text);
                    cost1.setText(String.format("%,d", value).replace(",", "."));
                }
            }
        });
        cost2.addKeyListener(new KeyAdapter() {
            @Override
            public void keyReleased(KeyEvent e) {
                String text = cost2.getText().replaceAll("\\D", "");
                if (!text.isEmpty()) {
                    long value = Long.parseLong(text);
                    cost2.setText(String.format("%,d", value).replace(",", "."));
                }
            }
        });
    }
...
//    }
    ...
    public void addDCMListener(DocumentListener l){
        ...
        cost1.getDocument().addDocumentListener(l);
        cost2.getDocument().addDocumentListener(l);
    }
